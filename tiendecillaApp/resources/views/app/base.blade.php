...
<!--===============================================================================================-->
    ...
    <link href="{{ url('tiendaassets/style.css') }}" rel="stylesheet">
	...
	<header class="header-v4">
			...
			<div class="wrap-menu-desktop how-shadow1">
				<nav class="limiter-menu-desktop container">
					...
					<div class="wrap-icon-header flex-w flex-r-m">
					    <ul class="main-menu">
    						<li class="icon-header-item cl2 hov-cl1 trans-04 p-l-22 p-r-11 icon-header-noti js-show-cart" data-notify="2">
    						...
    						<li class="icon-header-item cl2 hov-cl1 trans-04 p-l-22 p-r-11">
                                ...
                                @auth
                                    <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                        ...
                                        <span class="mr-2 d-none d-lg-inline text-gray-600 small">{{ Auth::user()->name }}, {{ Auth::user()->cargo }}</span>
                                    </a>
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                        ...
                                        @if(Auth::user() && Auth::user()->cargo == 'admin')
                                                <a class="dropdown-item" href="{{ url('producto') }}">
                                                    ...
                                                    <span>Admin Zone <i class="zmdi zmdi-folder-outline"></i></span>
                                                </a>
                                        @endif
                                ...
                                @else
                                    <a class="nav-link" href="{{ url('login') }}">
                                        <span class="mr-2 d-none d-lg-inline text-gray-600 small">Login <i class="zmdi zmdi-sign-in"></i></span>
                                    </a>
                                @endauth
        								</ul>
    						</li>
		...
		<div class="wrap-header-mobile">
			...
			<div class="logo-mobile">
				<a href="index.html"><img src="{{ url('images/icons/logo-01.png')}}" alt="IMG-LOGO"></a>
			</div>
	...
	<div class="wrap-header-cart js-panel-cart">
		...
		<div class="header-cart flex-col-l p-l-65 p-r-25">
			...
			<div class="header-cart-content flex-w js-pscroll" >
				<ul class="header-cart-wrapitem w-full" id="container-chart">
				...
				<div class="w-full">
					<div class="header-cart-buttons flex-w w-full">
						<a href="#" class="flex-c-m stext-101 cl0 size-107 bg3 bor2 hov-btn3 p-lr-15 trans-04 m-r-8 m-b-10" id="btnDeleteTotal">
							Borrar Carrito
						</a>
